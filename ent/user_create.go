...
func (uc *UserCreate) SetApikey(u uuid.UUID) *UserCreate {
	uc.mutation.SetApikey(u)
	return uc
}

// SetJwttoken sets the jwttoken field.
func (uc *UserCreate) SetJwttoken(s string) *UserCreate {
	uc.mutation.SetJwttoken(s)
	return uc
}

// SetNillableJwttoken sets the jwttoken field if the given value is not nil.
func (uc *UserCreate) SetNillableJwttoken(s *string) *UserCreate {
	if s != nil {
		uc.SetJwttoken(*s)
	}
	return uc
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.Apikey(); !ok {
		return &ValidationError{Name: "apikey", err: errors.New("ent: missing required field \"apikey\"")}
	}
	if _, ok := uc.mutation.ActivateCode(); !ok {
		return &ValidationError{Name: "activate_code", err: errors.New("ent: missing required field \"activate_code\"")}
	}
	if _, ok := uc.mutation.Activated(); !ok {
		return &ValidationError{Name: "activated", err: errors.New("ent: missing required field \"activated\"")}
	}
	if _, ok := uc.mutation.Locked(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Jwttoken(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
